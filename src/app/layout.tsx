...
export const metadata: Metadata = {
  title: "AIFlow - AI-Powered Business Automation Platform",
  description: "Transform your business with AIFlow. Automate workflows, gain AI-driven insights, and scale faster. Free trial available.",
  keywords: "AI platform, business automation, machine learning, workflow automation, enterprise AI",
  metadataBase: new URL("https://aiflow.example.com"),
  alternates: {
    canonical: "https://aiflow.example.com"
  },
  openGraph: {
    title: "AIFlow - AI-Powered Business Automation",
    description: "Unlock AI power for your business. Automate tasks, gain insights, and scale faster.",
    url: "https://aiflow.example.com",
    siteName: "AIFlow",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764063505907-0q9xdp7f.jpg",
        alt: "AIFlow Platform"
      }
    ]
  },
  twitter: {
    ...
    title: "AIFlow - AI-Powered Business Automation",
    description: "Transform your workflows with cutting-edge AI technology",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764063505907-0q9xdp7f.jpg"]
  },
  robots: {
    index: true,
    follow: true
